...
public class ControladoRegistroTelefonos implements Initializable{
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		//En este punto se sabe que todos los elementos de la GUI
			...
			do{
				...
				if(linea!=null) {
					...
					telefonos.add(new Telefono(
								new Marca(Integer.parseInt(partes[0]),partes[1]),
								new Modelo(Integer.parseInt(partes[2]),partes[3]),
								partes[4],
								new Color(Integer.parseInt(partes[5]),partes[6],null),
								partes[7],
								partes[8]
							)
					);
